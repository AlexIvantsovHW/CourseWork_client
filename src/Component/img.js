...
export function LinkImg(size){
  return(
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="currentColor" class="bi bi-link" viewBox="0 0 16 16">
...
export const Correct = (postCorrection) => {
  return (
...
export const img_return = (link, size = 80) => {
  return <img src={link} width={size} height={size} className="img-fluid" />;
};
