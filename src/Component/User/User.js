  ...
  return (
    <div class="col ">
     <div className={`row h-100 d-flex align-items-center text-white bg-${theme.bg} bg-gradient`}>
        <div 
        className={`col-10 col-sm-8 col-md-8 col-lg-6 mx-auto h-auto bg-${theme.bg} overflow-auto rounded-4 border border-${theme.border} border-opacity-50`} >
        <div className="mb-2">
        ...
        <div>
          ...
          <div 
            className={`w-100 d-flex flex-column align-items-center bg-${theme.bg} overflow-auto`} 
